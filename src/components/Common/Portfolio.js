...
const portfolio = [
  {title: 'Threads', subtile: 'Illustration', image: img1},
  {title: 'Explore', subtile: 'Graphic Design', image: img2},
  {title: 'Finish', subtile: 'Identity', image: img3},
  {title: 'Lines', subtile: 'Branding', image: img4},
  {title: 'Southwest', subtile: 'Website Design', image: img5},
  {title: 'Window', subtile: 'Photography', image: img6}
]
