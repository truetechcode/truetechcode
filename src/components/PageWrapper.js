      ...
      <div>
        <nav className="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
          <div className="container">
            <Link className="navbar-brand" to="/">truetechcode</Link>
            ...
            <div style={{display: this.state.collapse ? '' : 'none'}} className="navbar-collapse" id="navbarResponsive">
              <ul className="navbar-nav text-uppercase ml-auto">
                ...
                <li className="nav-item" style={{}}>
                  <Link className="nav-link js-scroll-trigger" style={{}} target="_blank" to="//drive.google.com/open?id=1lHan1rh7GycL13nRAP5pcJEeynu0tLtx">My Resume</Link>
              </li>
              </ul>
            </div>
          </div>
